...
%Auch das Feld "`FO-Leistung gesamt"' muss angepasst werden. Bei der Cockpitbesatzung zählen Flugschüler bereits zu Beginn einer Schulung zum Bestand einer neuen \ac{PU}. Falls sie während der Schulung von einem bestehenden Piloten der neuen \ac{PU} betreut werden müssen, wird dieser unter dem Feld "`FO-Leistung"' von dem Bestand wieder subtrahiert. Bei der Kabinenbesatzung zählt ein/e Flugschüler/in erst zu der neuen \ac{KG}, wenn er oder sie die Schulung beendet hat, leistet aber während der Schulung auch schon Flugstunden für die neue \ac{KG}. \\%Lösung dafür?, TODO FO-Leistung?
